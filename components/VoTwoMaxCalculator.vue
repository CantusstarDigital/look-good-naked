<template>
    <div class="bg-white py-8 px-4 border-2 border-gray-950 shadow sm:px-10 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="flex flex-col gap-4">
            <h2 class="text-xl text-gray-900 font-bold">VO2 Max Calculator</h2>
      <div>
      ...
      <button @click="calculateVO2Max" class="rounded-full bg-gray-700 py-2 px-4 text-white hover:bg-gray-950 cursor-pointer font-bold">Calculate VO2 Max</button>
      <div v-if="vo2Max">
