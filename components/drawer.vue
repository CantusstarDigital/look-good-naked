<template>
    <div id="drawer-right" class="fixed top-0 right-0 z-50 h-screen p-4 pr-0 overflow-y-auto transition-transform translate-x-full bg-white w-80" tabindex="-1" aria-labelledby="drawer-right-label">
        <button type="button" data-drawer-hide="drawer-right" aria-controls="drawer-right" class="absolute right-4 top-4 px-2 leading-10 rounded transition-all bg-gray-50 hover:bg-gray-100 hover:text-gray-950" >
            Close
        </button>
