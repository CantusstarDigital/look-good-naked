            ...
            <div class="flex flex-col gap-6">
                ...
                <div>
                    <NuxtLink to="/" class="flex cursor-pointer">
                        <img src="/img/logo-dark.svg" width="60px" height="60px" alt="Phantom Wellness" title="Phantom Wellness" loading="eager" />
                    </NuxtLink>
                </div>

                <div class="font-bold">    
                    <NuxtLink to="/tools" class="text-xl mr-8 inline-flex leading-10 transition-all hover:text-gray-950">Fitness Tools</NuxtLink>              
                    <NuxtLink to="/dietary" class="text-xl mr-8 inline-flex leading-10 transition-all hover:text-gray-950">Dietary Preferences</NuxtLink>
                    <NuxtLink to="/fitness" class="text-xl mr-8 inline-flex leading-10 transition-all hover:text-gray-950">Fitness Goals</NuxtLink>
                </div>
