<template>
    <div class="bg-white py-8 px-4 border-2 border-gray-950 sm:rounded-lg sm:px-10 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="flex flex-col gap-4">
            <h2 class="text-xl text-gray-900 font-bold">Calorie Calculator</h2>
