...
<template>
    <div class="mt-12 flex border-t border-slate-200 pt-6">
        <div class="grid grid-cols-2 w-full gap-10">
            <div class="">
                <div v-if="prev">
                    <div class="text-sm font-medium text-slate-900"><span>←</span> Prev</div>
                    <div class="mt-1">
            ...
            <div>
                <div v-if="next" class="text-right">
                    <div class="text-sm font-medium text-slate-900">Next <span>→</span></div>
                    <div class="mt-1">
