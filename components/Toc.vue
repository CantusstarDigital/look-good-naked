...
<template>
  <nav role="list" class="space-y-9">
    <div class="font-display font-medium text-gray-900 dark:text-white">Content of Article</div>
      <ul id="tocNav" role="list" class="mt-2 space-y-2 border-l-2 border-slate-100 dark:border-gray-800 lg:mt-4 lg:space-y-4 lg:border-slate-200">
